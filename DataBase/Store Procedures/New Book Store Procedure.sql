...
-------Store Procedure for Image Upload-------
...
as
Update BookTable set BookImage = @BookImage where Book_Id=@Book_Id
go

drop procedure SPBookImageUpload

exec SPBookImageUpload 1,'abcde'